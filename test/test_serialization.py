...
class TestSerialization(TestCase, SerializationMixin):
    ...
    def test_serialization_warning_s390x(self):
        ...
        try:
            ...
            with self.assertWarnsRegex(UserWarning, "The default load endianness for checkpoints without a byteorder mark on big endian machines was changed from 'native' to 'little' endian"):
                tensor_be_no_bom = torch.load(buf_be_no_bom)
        finally:
            set_default_load_endianness(current_load_endian)
